  ...
  const uploadImage = async () => {
    ...
    try {
      ...
      if (publicUrlError || !publicUrlData?.publicUrl) {
        throw publicUrlError || new Error('Failed to generate public URL for certificate image.')
      }

      const { error: insertError } = await supabase
        .from('certificates')
        .insert({ img: publicUrlData.publicUrl })
      ...
      alert(`Cannot upload certificate: ${error.message}`)
    } finally {
      setUploading(false)
    }
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        <div className="relative">
          ...
          <div className="relative w-9 h-9 bg-[#1a1a1a] rounded-xl border border-white/15 flex items-center justify-center">
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap">
              ...
              <div className="flex gap-2 shrink-0">
                ...
                <button onClick={uploadImage} disabled={uploading} className="relative group/u">
                  ...
                  <div className="relative flex items-center gap-2 px-4 py-1.5 bg-[#1a1a1a] rounded-xl border border-white/10">
