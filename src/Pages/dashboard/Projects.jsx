...
export default function Projects() {
  ...
  const uploadImage = async (f) => {
    ...
    if (publicUrlError || !publicUrlData?.publicUrl) {
      throw publicUrlError || new Error("Failed to generate public URL for project image.");
    }
  ...
  const handleCreate = async (form, file) => {
    ...
    try {
      ...
      if (error) {
        ...
        alert(`Cannot add project: ${error.message}`);
        setUploading(false);
        return;
      }
  ...
  const handleEdit = async (form, file) => {
    ...
    try {
      ...
      if (error) {
        ...
        alert(`Cannot update project: ${error.message}`);
        setUploading(false);
        return;
      }
    ...
    <div className="space-y-6z ">
      ...
      <div className="flex items-center justify-between gap-4 mb-6 flex-wrap">
        ...
        >
          ...
          <div className="relative flex items-center gap-2 px-4 py-2.5 bg-[#1a1a1a] rounded-xl border border-white/10">
