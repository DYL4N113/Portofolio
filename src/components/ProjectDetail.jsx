...
const ProjectDetails = () => {
  ...
  useEffect(() => {
    ...
    if (selectedProject) {
      const enhancedProject = {
        ...
        Github: selectedProject.Github || "https://github.com/DYL4N113",
      };
    ...
    const fetchProjectBySlug = async () => {
      ...
      const foundProject = normalizedProjects.find((p) => toSlug(p.Title) === slug);
      if (foundProject) {
        const enhancedProject = {
          ...foundProject,
          Features: foundProject.Features || [],
          TechStack: foundProject.TechStack || [],
          Github: foundProject.Github || "https://github.com/DYL4N113",
        };
        setProject(enhancedProject);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-[#0f0f0f] flex items-center justify-center">
        <div className="text-center space-y-6 animate-fadeIn">
          <div className="w-16 h-16 md:w-24 md:h-24 mx-auto border-4 border-gray-500/30 border-t-gray-400 rounded-full animate-spin" />
  ...
  return (
    <>
      <Helmet>
        <title>{project.Title} — Rasya Dylan Pratama</title>
        <meta
          name="description"
          content={
            project.Description
              ? project.Description.slice(0, 155)
              : `Project ${project.Title} oleh Rasya Dylan Pratama — Software Engineer.`
          }
        />
        ...
        <meta
          property="og:title"
          content={`${project.Title} — Rasya Dylan Pratama`}
        />
        <meta
      ...
      <div className="min-h-screen bg-[#0f0f0f] px-[2%] sm:px-0 relative overflow-hidden">
        <div className="fixed inset-0">
          <div className="absolute -inset-[10px] opacity-20">
            <div className="absolute top-0 -left-4 w-72 md:w-96 h-72 md:h-96 bg-slate-700 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob" />
            <div className="absolute top-0 -right-4 w-72 md:w-96 h-72 md:h-96 bg-slate-600 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-2000" />
            <div className="absolute -bottom-8 left-20 w-72 md:w-96 h-72 md:h-96 bg-slate-700 rounded-full mix-blend-multiply filter blur-3xl opacity-70 animate-blob animation-delay-4000" />
          </div>
